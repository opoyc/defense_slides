...
- Define a set of potential drivers of Bitcoin price, that lets to: 
  - Generate hypothesis.
- Determine which are relevant social, financial and macroeconomic factors determine Bitcoin's price. That help to shed light about the scope and consequences for the economy. 
...
- A Spatio-temporal perspective of attraction, the most relevant predictor of BTC price.
  - Bayesian variable selection of the drivers based on a data-driven approach known as Spike and Slab.
