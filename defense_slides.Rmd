...
- Attractiveness were found to be the most relevant variables related to the Bitcoin price. 
]
...
1. Bitcoin is represented by an amalgam of features and uses, which makes it difficult to frame it into a precedent element in economic studies.
  ...
  1. Bitcoin's impact will depend greatly on the forces that drive the price since it exposes its application.
