...
```{r, echo = FALSE, fig.cap="Cumulative impulse response function (IRF) for VAR of Bitcoin's returns (BTC) to the rest of the variables in the system", out.width="90%", fig.align='center'}
knitr::include_graphics("img/irf_btc.png")
```

---


```{r, echo = FALSE, fig.align='center', out.width="90%", fig.cap="Cumulative impulse response function (IRF) for VAR of attention (ATT) to the rest of the variables in the system"}
knitr::include_graphics("img/irf_att.png")
```

---

```{r, echo = FALSE, fig.align='center', out.width="90%", fig.cap="Cumulative impulse response function (IRF) for VAR of attention (ATT) to the rest of the variables in the system"}
knitr::include_graphics("img/irf_btcv.png")
```

---

```{r, echo = FALSE, fig.align='center', out.width="90%"}
knitr::include_graphics("img/irf_hind.png")
```

---

```{r, echo = FALSE, fig.align='center', out.width="90%"}
knitr::include_graphics("img/irf_hinu.png")
```