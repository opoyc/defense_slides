...
- Officially, Bitcoin is a decentralized digital currency, that allow users to send bitcoins on a peer to peer network without intermediaries.
...
- Low speed of transactions due to long verification process is disadvantage in front of typical mechanisms to change money.
