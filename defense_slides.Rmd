...
.midle[
1 - [Motivation](a2_zew.html#3)

2 - [Objective](a2_zew.html#10)

3 - [Background](a2_zew.html#17)

4 - [Literature review](a2_zew.html#38)

5 - [Data, Methodology, and Model](a2_zew.html#75)

6 - [Empirical results](a2_zew.html#92)

7 - [Conclusions](a2_zew.html#99)
]
...
1. Exploring the dynamics of Bitcoin Price: A Bayesian Structural Time Series Approach.
...
1. Investors’ biases and herding behavior in the cryptocurrency market.
> Posits behavioral economics principles to explain cryptocurrencies' price dynamics.
1. Attention, meta-information and behavioral convergence in cryptocurrency markets: A SVAR analysis
> Proposes a structural form about information feedback that molds cryptocurrency markets.
...
knitr::include_graphics("img/drivers2.jpg")
```
]

.pull-right[
```{r, echo=F, fig.align="center", fig.cap="Clustered GSI by country", out.width="100%"}
knitr::include_graphics("img/cluster_countries.png")
```
]
...
knitr::include_graphics("img/dyncoef.png")
```
...
knitr::include_graphics("img/kindleberger.png")
```
...
## Herding behavior in crypto-markets: a beauty contest
...
## Herding behavior in crypto-markets: relevant literature
...
## Methodology: Cross-Sectional Standard Deviation of Returns (CSSD)

+ To date few methods have been developed to test for empirical herding under prices settings
+ Crypto-market investors' decision are almost impossible to be measured directly, hence this study will follow prices as coordination mechanism.
...
## Methodology: Cross-Sectional Absolute Deviation of Returns (CSAD)
...
---
## Model: Markov Regime-Switching model for herding behavior
**Herding behavior under asymmetric states**
...
.center[
```{r, fig.cap="Regression estimates of herding behavior under symmetric", echo=FALSE, out.width="70%"}
knitr::include_graphics("img/reg1_woc.png")
```
]
...
#### Regime switching smoothed probabilities and estimates under symmetric herding behavior

```{r, echo=FALSE, fig.align='center', out.width="60%"}
knitr::include_graphics("img/reg1_wc.png")
```

```{r, echo=FALSE, fig.align='center', out.width="50%"}
knitr::include_graphics("img/sp_reg_1.png")
```
...
```{r, fig.cap="Regression estimates of herding behavior under asymmetric states", echo=FALSE, out.width="100%"}
knitr::include_graphics("img/reg2_woc.png")
```

---
class: middle
#### Regime switching smoothed probabilities and estimates under asymmetric herding behavior

```{r, echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("img/reg2_wc.png")
```

```{r, echo=FALSE, out.width="50%", fig.align='center'}
knitr::include_graphics("img/sp_reg_2.png")
```
